...
max_sum = -1 # наибольшая сумма двух элементов, отстоящих друг от друга на 4 и более позиции, - ответ на вопрос задачи
a, b = -1, -1
...
for i in range(4, n):
    ...
    s = max_left + right_element
    if s > max_sum:
        max_sum = s
        a, b = max_left, right_element
